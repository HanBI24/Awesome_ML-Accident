...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnDetectObject, btnToggleCamera, btnUpload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("MainActivityImageView", "oncreate");
        ...
        Button btnResultActivity = findViewById(R.id.btnSecondActivity);
